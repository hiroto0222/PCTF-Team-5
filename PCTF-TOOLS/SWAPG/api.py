...
if __name__ == '__main__':
	...
	teamToken = "04gwUvwtpPZzbzMMyaYGwMkTW3eBx34N"
	...
	for service in serviceIds:
		...
		#api.submitFlag("FLGv4PCcsMuzq5Se")

		if (len(sys.argv) > 2):
			print("The input should be of the form: ./api.py FLGXXXXXXX to submit the flag")
		elif (len(sys.argv) == 1):
			print("To submit the flag use ./api.py FLGXXXXXXX format")
		else:
			api.submitFlag(sys.argv[1])
